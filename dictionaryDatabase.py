...
nouns = {'lightning': 'olwaadhi', 'lightnings': 'oombadhi', 'scar': 'oshaadhi', 'scars': 'iiyadhi', 'arm':
         ...
         'animals': 'iinamwenyo', 'Saturday': 'Olyomakaya', 'on Saturday': 'mOlyomakaya',
         ...
         'wild animal': ['oshiyamakuti'], 'angel': ['omuyengeli (aa-)'], 'angle': ['okolonela (oo-)', 'ekuvu (oma-)',
         'onkuvu (oo-)'], 'Anglican church': ['ongeleka yaAngilikana']
...
verbs = {'find': ['adha'], 'found': ['adhika'], 'shine': ['ota dhi adhima'], 'shines': ['oha yi adhima'], 'shining':
         ['ota yi/dhi adhima'], 'glorify': ['adhimitha'], 'glorified': ['adhimithwa'], 'grab': ['yakula'], 'crucify':
         ['ota ya alele komushigakano'], 'crucifies': 'ota alele komushigano', 'crucified': 'alela komushigakano',
         'cure': 'aludha', 'cures': 'aludha', 'recover': 'get well', 'ill': 'alukwa', 'eavesdrop': 'ambela',
         ...
         'is rolling': 'ota galangata', 'pray': 'galikana', 'prayed': 'okwa galikana', 'praying': 'galikana',
         'he came back': 'okwa galuka', 'she came back': 'okwa galuka', 'they came back': 'oya galuka',
         'it came back': 'osha galuka', 'we came back': 'otwa galuka', 'come back': 'galuka', 'bring back': 'galula',
         'he brought back':
         ...
         'abduct': ['mbemba(e) po'], 'absorb': ['(moisture)', ' nina (omeya)'], 'abstain': ['idhilika (e)'],
         'accelerate': ['ulumika', 'endelelitha'], 'accompany': ['enda (n-)', 'thindikila (e)'], 'accuse':
         ['lundila (e)'], 'adapt': ['iyikitha', 'iyigililitha'], 'try': ['kambadhala'], 'add': ['gwcdha'], 'adhere':
         ['(to) kakatela (e)'], 'adjourn': ['zimbuka', 'zimbula', 'The meeting adjourned at five',
         'Oshigongi osha zimbuka pontano'], 'adulterate': ['hondela'], 'advise': ['pa/gandja/tsa omayele'],
         ...
         'I aim at the head of the bird with the gun', 'Otandi odho komutse gwokadhila nokandjembo'],



             alone(only) - ke.I  # ngame andike
             alone(by
         myself) -ene.I  # ngame mwene alphabet o(h)aambeendee
...
have
time
for you.Ondi ku nine okathimbo.


wild  # oshiyarnakuti (ii-)
...
adjectives = {'all': 'adhihe', 'delirious': 'adhuuka', 'whole': 'aguhe', 'supreme': 'yo pombanda', 'two': ['mbali'],
              ...
              ['elakana'], 'greedy': 'lumba', 'dirty': 'gagala', 'abundant': ['sha ha (hi)'], 'accustomed':
              ['igilila (e)'], 'agricultural': ['-kwafaalama'], 'the best': ['dhingi'], 'tasty':
              ['dhoga'], 'naked': ['omudhu'], 'nude': ['e li ', 'omudhu'], 'jealous': ['okwa sa efupa'], 'is short':
              ['omufupi'], 'are short': ['aafupi'], 'is tall': ['omule'], 'are tall': ['aale'], 'is vain':
              ['omufuuli'], 'absent': ['ke po', 'a faula'], 'accidental': ['shopapuko'], 'aesthetic':
              ['uuwopali (omau-)'], 'alkaline': ['paalikali', 'pashimongwa'], 'angry': ['geya (e)'],
              }


prepositions = {'about': ['search about', 'petapeta', 'thimbilathjmbjja (e)'], 'above': ['kombanda [y(a-)]',
                'The person is looking above = ', 'Omuntu ota tala kombanda', 'An aeroplane is flying over the mountain. = ',
                'Kombanda yondundu otaku tuka ondhila.', 'The man stays on the other side of Oshitutuma. = ',
                'Omusamane okwa kala kombanda yaShitutuma.'], 'after': ['konima (y(a-))', 'The taxi came after a while.',
                'Otaxi oyeya konima yethimbo.', 'Our house is behind.', 'Egumbo lyetu oli li konima.'], 'against':
                ['pooha [dh(a-)]', 'Stand against the wall.', 'Thikama pooha dhekuma.'],
                }

adverbs = {'only': 'ageke', 'everywhere': 'apehe', 'please': 'alikana', 'always': 'aluhe', 'apparently': 'aniwa', 'yes':
            'eeno', 'no': 'aawe', 'accurately': ['lela', 'naanaa'], 'accidentally': ['papuko', 'ohaluka', 'pashaadhilila'],
           'again': ['ishewe', 'natango'], 'ahead': ['komeho', 'Look ahead, do not look back.',
            'Tala komeho, inoo tala konima.'], 'alphabetically': ['paambeendee', 'pahaambeendee'],
           }

pronouns = {'they': 'yo', 'he': 'ye', 'she': 'ye', 'they are': 'ota ya', 'we are': 'ota tu', 'he is': 'ota', 'she is': 'okwa',
            'it is': 'osha', 'to us': 'ku se', 'us': 'se', 'they have': 'oya', 'we have': 'otwa', 'he has': 'okwa', 'she has':
            'okwa', 'other': 'galwe', 'other people': 'aantu yalwe', 'other things': 'iinima yilwe'
            }
...
conjuctions = {'and': 'e'}
phrases ={'according to': ['pa-', 'according to nature = ', 'paunshitwe'], 'try on': ['iyeleka'], 'on account of': ['molwa-'],
